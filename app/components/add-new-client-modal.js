...
export default Ember.Component.extend({
  ...
  actions: {
    createNewClient() {
      this.set('form.country', 'USA');
      this.set('form.active', this.get('selectedActiveState'));
      this.set('form.state', this.get('selectedState'));
      this.store.createRecord('advertiser', this.get('form')).save().then(() => {
        this.set('form', {});
